...
('00384393431', 'João da Silva', 'Rua Projetada A', 'Número 233', 'Copacabana', 'RJ', '20000000',
'1965-03-21',57, 'M', 200000, 3000.30,1),
('00384393555', 'Maria Clara', 'Rua Projetada A', 'Número 233', 'Copacabana', 'RJ', '20000000',
...
ALTER TABLE [TABELA DE CLIENTES] ADD [CIDADE] [VARCHAR] (50)
...
ALTER TABLE [TABELA DE CLIENTES] DROP COLUMN [CIDADE]

INSERT INTO [TABELA DE CLIENTES] 
([CPF],[NOME],[RUA],[COMPLEMENTO],[BAIRRO],[ESTADO],[CEP],[DATA DE NASCIMENTO],[IDADE],[SEXO],[VOLUME MINIMO],[LIMITE DE CREDITO],[PRIMEIRA COMPRA])
VALUES
